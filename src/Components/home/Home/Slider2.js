...
const Carousel2 = () => {
    ...
    return (
        <div className="relative w-full h-screen">
            {/* Slide */}
            <div
                className="w-full h-full flex items-center text-white transition-all duration-500"
                style={{
                    backgroundImage:
                        'url("https://thechefkart.com/_next/image?url=https:%2F%2Fchefkart-strapi-media.s3.ap-south-1.amazonaws.com%2FWebsite_Homepage_banner_01_9ec160c34d.webp&w=3840&q=75")',
            ...
            >
                ...
                <div className="w-full md:w-1/2 p-10 md:p-16 rounded-r-lg ml-4">
                    ...
                    <p className="text-2xl text-orange-500 font-bold mt-10">
