    ...
    <div className="flex flex-wrap -m-4">
      ...
      <div className="p-4 md:w-1/3">
        <div className="rounded-lg overflow-hidden">
          ...
          <div className="p-6">
            ...
            <p className="leading-relaxed mb-3 text-center font-bold text-black">अपनी दैनिक कमाई के पैसे नियमित रूप से उसी दिन पाएँ।</p>
      ...
      <div className="p-4 md:w-1/3">
        <div className="h-full rounded-lg overflow-hidden">
          ...
          <div className="p-6">
            ...
            <p className="leading-relaxed mb-3 text-center font-bold text-black">समाज में एक पेशेवर कुक के रूप में सम्मान और पहचान प्राप्त करें।।</p>
      ...
      <div className="p-4 md:w-1/3">
        <div className="h-full rounded-lg overflow-hidden">
          ...
          <p className="leading-relaxed mb-3 text-center font-bold text-black">हमारे शेफ़ से ट्रेनिंग में नए पकवान बनाना सीखें। किसी भी समस्या में तुरंत सहायता पाएँ। </p>
