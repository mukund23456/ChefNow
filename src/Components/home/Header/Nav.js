...
//   return (
//     <header className="fixed top-0 w-full z-30 bg-black text-white shadow-lg">
...
//             <button
//               className="mr-5 text-2xl text-white hover:text-blue-500 hover:underline flex items-center"
...
//                 <Link
//                   to="/cook-for-month"
//                   className="px-4 py-2 block text-lg font-bold hover:text-blue-500"
//                 >
//                     Maid for a Month
...
//           </Link>
//           <Link to="/contact">
//           <button className="text-white text-center text-2xl bg-blue-500 py-2 px-6 rounded-lg hover:bg-blue-600">
//             Contact Us
//           </button>
//           </Link>
//         </nav>
...
//         >
//           < MdOutlineCleaningServices className="w-10 h-10" />
//         </button>
//       </div>
